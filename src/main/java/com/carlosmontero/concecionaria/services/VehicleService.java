...
public class VehicleService<T extends Vehicle> {
    ...
    public List<Vehicle> searchVehicles(String brand, String name, Integer year, Double price,
     ...
     *
     * @param availability
     * @param v tipo de vehículo
     * @return true
     */

//    private boolean isValidAvailability(String availability, Vehicle v) {
//        if (availability == null) {
//            return true; // If availability is null, don'v filter by it
//        }
//
...
//            return v.getAvailability() == availEnum;
...
//                return v.getAvailability() == Availability.FOR_SALE;
//            }
...
//    private boolean isValidUsedState(String usedState, Vehicle v) {
//        if (usedState == null) {
//            return true;
//        }
//
...
//            return v.getUsedState() == usedStateEnum;
//        } catch (IllegalArgumentException e) {
//
//            return false;
//        }
//
//    }
    protected boolean isValidAvailability(String availability, Vehicle vehicle) {
        try {
    ...
    protected boolean isValidUsedState(String usedState, Vehicle vehicle) {
        try {
